 ...
 *  Must stay in @layer base so Tailwind utilities (also layered) can override —
 *  unlayered rules beat @layer and were wiping link colors + input borders. */
...
@layer base{
  *,::before,::after{box-sizing:border-box}
  ...
  #main-content>section:first-child a[href^="tel:"]{display:inline-flex;align-items:center;justify-content:center;gap:.5rem;background:var(--color-primary);color:var(--color-primary-foreground);font-weight:700;padding:.75rem 1.25rem}
